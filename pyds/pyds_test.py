...
from src.experiments.pyds import (
    MassFunction,
    gbt_bel,
    gbt_m,
    gbt_pignistic,
...
class PyDSTest(unittest.TestCase):
    ...
    def test_combine_conjunctive(self):
        ...
        test(
            self.m1.combine_conjunctive(self.m2, normalization=False, sample_count=10000, importance_sampling=True),
            0.45,
            1,
        )  # ImpSam should be ignored
    ...
    def test_weight_function(self):
        ...
        self.assertAlmostEqual(7.0 / 4.0, w1[frozenset("b")])
        self.assertAlmostEqual(2.0 / 5.0, w1[frozenset("ab")])
        self.assertAlmostEqual(1.0, w1[frozenset("c")])
        self.assertAlmostEqual(1.0, w1[frozenset("ac")])
        self.assertAlmostEqual(2.0 / 7.0, w1[frozenset("bc")])
        ...
        self.assertAlmostEqual(3.0 / 7.0, w2[frozenset("bc")])
    ...
    def test_confidence_intervals(self):
        ...
        for h, p_u in upper.items():
            ...
            self.assertAlmostEqual(2.0 * p - lower[h], p_u, places=1)
    ...
    def test_from_samples(self):
        ...
        self.assertAlmostEqual(
            1.0 / float(sum(precipitation_data.values()) + 1), m[MassFunction._convert(precipitation_data.keys())]
        )
        for e, n in precipitation_data.items():
